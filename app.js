...
function encriptar() {
    ...
    /*if (window.matchMedia('(max-width: 430px)').matches) {
        miDiv.style.height = 'auto'; // Nueva altura7
        miDiv.style.width = 'auto'; // Nueva altura7
        nuevoDiv.style.height = 'auto'; // Nueva altura7
        nuevoDiv.style.width = 'auto'; // Nueva altura7
